...
\begin{figure}[h]
	 ...
	 \end{center}
\end{figure}
	The key innovation proposed in the present paper is what we call the Sequential Child-Combination Tree-LSTM architecture. In order to combine, children nodes with their parents we follow the transition equations specified below:
\begin{equation}
\begin{split}
